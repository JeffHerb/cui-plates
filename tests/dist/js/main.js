...
define('plates',[],function () { 'use strict';
	...
	class Switch {
		...
		parser(oContext, oASTNode) {
			...
			let vActualContextValue = Context$1.find(oASTNode.globalConditional.test, oContext);
			...
			for (let c = 0, cLen = oASTNode.conditionals.length; c < cLen; c++) {
				...
				if (oConditional.type === "static") {
					...
					vConditionalValue = Context$1.find(oConditional.test, oContext);
				}
